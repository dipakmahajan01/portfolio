...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      href: 'https://github.com/dipak-mahajan-9017b821b',
      icon: (
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/dipak-mahajan-9017b821b/',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Twitter',
      href: 'https://x.com/dippakkcoder_01',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/_dipak08/',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="p-3 bg-dark-800 hover:bg-dark-700 rounded-lg transition-all duration-200 group"
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-500 text-sm">
              © {currentYear} Dipak Mahajan. All rights reserved.
            </p>
